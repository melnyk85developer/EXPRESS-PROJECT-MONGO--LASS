export const TYPES = {
    MongoDBCollection: Symbol.for('MongoDBCollection'),

    UsersRepository: Symbol.for('UsersRepository'),
    UsersQueryRepository: Symbol.for('UsersQueryRepository'),
    UserSessionsRepository: Symbol.for('UserSessionsRepository'),
    UserSessionsQueryRepository: Symbol.for('UserSessionsQueryRepository'),
    ...
    SecurityDeviceServices: Symbol.for('SecurityDeviceServices'),
