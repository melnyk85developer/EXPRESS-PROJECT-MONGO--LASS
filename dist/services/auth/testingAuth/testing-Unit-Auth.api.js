...
const authUnitTest = () => {
    ...
    describe('UNIT-AUTH', () => {
        beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            compositionRootCustom_1.mongoDBCollection.tokensCollection = {
                insertOne: jest.fn(),
                deleteOne: jest.fn(),
                findOne: jest.fn(),
            };
        ...
        describe('generateTokens', () => {
            it('Должен выдать ошибку, если полезная нагрузка равна null или не определена', () => __awaiter(void 0, void 0, void 0, function* () {
                yield expect(compositionRootCustom_1.tokenService.generateTokens(null, '-100')).rejects.toThrow('Payload cannot be null or undefined');
            }));
            it('Должны возвращать маркеры доступа и обновления', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const result = yield compositionRootCustom_1.tokenService.generateTokens('123', '321');
        ...
        describe('validateAccessToken', () => {
            it('Должен возвращать statusCode, если токен недействителен', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const result = yield compositionRootCustom_1.tokenService.validateAccessToken(mockToken);
        ...
        describe('validateRefreshToken', () => {
            it('Должен возвращать statusCode, если формат токена недействителен', () => __awaiter(void 0, void 0, void 0, function* () {
                const mockToken = 'invalidFormatToken';
                const result = yield compositionRootCustom_1.tokenService.validateRefreshToken(mockToken);
        ...
        describe('saveBlackListToken', () => {
            it('Должен вставить токен в базу данных', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                compositionRootCustom_1.mongoDBCollection.tokensCollection.insertOne.mockResolvedValueOnce({ insertedId: new mongodb_1.ObjectId() });
                const result = yield compositionRootCustom_1.tokenService.saveRefreshTokenBlackList(mockUserId, mockRefreshToken);
                expect(result).toEqual({ insertedId: expect.any(mongodb_1.ObjectId) });
                expect(compositionRootCustom_1.mongoDBCollection.tokensCollection.insertOne).toHaveBeenCalledWith({ userId: mockUserId, refreshToken: mockRefreshToken });
            }));
            it('Должен возвращать объект ошибки, если произошла ошибка', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                compositionRootCustom_1.mongoDBCollection.tokensCollection.insertOne.mockRejectedValueOnce(mockError);
                const result = yield compositionRootCustom_1.tokenService.saveRefreshTokenBlackList(mockUserId, mockRefreshToken);
        ...
        describe('removeToken', () => {
            it('Должен удалить токен из базы данных', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                compositionRootCustom_1.mongoDBCollection.tokensCollection.deleteOne.mockResolvedValueOnce({ deletedCount: 1 });
                const result = yield compositionRootCustom_1.tokenService.deleteRefreshTokenByTokenInBlackList(mockRefreshToken);
                expect(result).toEqual({ deletedCount: 1 });
                expect(compositionRootCustom_1.mongoDBCollection.tokensCollection.deleteOne).toHaveBeenCalledWith({ refreshToken: mockRefreshToken });
            }));
        });
        describe('findToken', () => {
            it('Должен возвращать данные о маркере из базы данных', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                compositionRootCustom_1.mongoDBCollection.tokensCollection.findOne.mockResolvedValueOnce(mockTokenData);
                const result = yield compositionRootCustom_1.tokenService.getRefreshTokenByTokenInBlackList(mockRefreshToken);
                expect(result).toEqual(mockTokenData);
            }));
            it('Должен возвращать null, если токен не найден', () => __awaiter(void 0, void 0, void 0, function* () {
                const mockRefreshToken = 'mockRefreshToken';
                // Мокируем MongoDB метод findOne, используя типизацию
                compositionRootCustom_1.mongoDBCollection.tokensCollection.findOne.mockResolvedValueOnce(null);
                const result = yield compositionRootCustom_1.tokenService.getRefreshTokenByTokenInBlackList(mockRefreshToken);
