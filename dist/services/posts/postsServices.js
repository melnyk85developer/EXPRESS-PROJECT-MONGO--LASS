...
let PostsServices = class PostsServices {
    constructor(blogsQueryRepository, commentsRepository, commentsQueryRepository, postsRepository) {
...
exports.PostsServices = PostsServices = __decorate([
    ...
    __param(3, (0, inversify_1.inject)(postsRepository_1.PostsRepository)),
