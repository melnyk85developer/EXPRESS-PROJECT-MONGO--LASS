...
const authControllers = () => {
    ...
    router.post(`/registration`, authArrayMiddlewares_1.registrationMiddlewares, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    router.post(`/login`, authArrayMiddlewares_1.loginMiddlewares, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        ...
        const result = yield authServices_1.authServices.loginServices(String(userId), ip, title);
    ...
    router.post(`/logout`, authArrayMiddlewares_1.logoutMiddlewares, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    router.post(`/refresh-token`, authArrayMiddlewares_1.refreshTokenMiddlewares, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    router.get(`/confirm-email`, authArrayMiddlewares_1.confirmationEmailMiddlewares, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    router.post(`/registration-confirmation`, authArrayMiddlewares_1.registrationConfirmMiddlewares, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    router.post(`/registration-email-resending`, authArrayMiddlewares_1.registrationEmailResendingMiddlewares, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    router.get(`/me`, authArrayMiddlewares_1.meMiddlewares, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
