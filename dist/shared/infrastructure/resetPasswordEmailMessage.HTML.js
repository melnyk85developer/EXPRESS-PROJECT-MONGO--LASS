...
exports.resetPasswordEmailMessageHTMLDocument = void 0;
const resetPasswordEmailMessageHTMLDocument = (nameProjekt, to, text, link, user) => {
    return (`
    <section style="
        margin: 0;
        padding: 5px;
...
exports.resetPasswordEmailMessageHTMLDocument = resetPasswordEmailMessageHTMLDocument;
